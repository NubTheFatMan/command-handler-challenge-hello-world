...
exports.allowed = ['292447249672175618']; // Bot dev's should be the only "allowed" people.
exports.callback = (message, args) => {
    ...
    if (plugin === '*') {
        ...
        // if no command or event was found above, the user must have input a file that hasn't already been registered
        if (!reloaded) {
            try {
